...
class Dendogram:
    ...
    def drawdend(self):
        ...
        self.drawtier(40, 100, "blue green red".split(), [5, 5, 7], [1, 1, 1])
        self.drawtier(100, 160, DEMO, [4]*14, [3, 3, 5])
        self.drawtier(160, 220, "blue green red".split()*14, [3]*14, [2]*14)
    ...
    def drawtier(self, l0=100, l1=200, color=DEMO, spacing=[], arcs=[]):
        # l0, l1 = 100, 200
        lines = len(color)
        ...
        for r in range(lines):
            angle = spacing.pop(0)
            d0, h0 = sin(r*step*angle), cos(r*step*angle)
